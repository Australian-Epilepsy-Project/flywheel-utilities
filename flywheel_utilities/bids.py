...
def create_bids_dir(context: 'GearToolkitContext',
                    subject: 'ContainerSubjectOutput',
                    modalities: List[str],
                    add_description: bool =True) -> Path:
    '''
...
def create_deriv_dir(context: 'GearToolkitContext',
                     sub_label: str,
                     which_version: str = "first") -> Path:
    '''
    ...
    if which_version != "none":
        ...
        assert result is not None, ("Could not isolate Flywheel versioning in gear name when"
